...
public class tester {
    public static void main(String[] args) {
        ...
        System.out.println("Weight from Kuching to Melaka: " + graph1.getEdgeWeight("Kuching", "Melaka"));
        System.out.println("Weight from Tawau to Alor Setar: " + graph1.getEdgeWeight("Tawau", "Alor Setar"));
        System.out.println("Weight from Semporna to Ipoh " + graph1.getEdgeWeight("Semporna", "Ipoh"));
        System.out.println();
